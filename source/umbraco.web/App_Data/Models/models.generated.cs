...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "36a44e7976d3e7ad")]
...
#pragma warning restore 0109
	...
	[PublishedContentModel("prova")]
	public partial class Prova : Master
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "prova";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public Prova(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Prova, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
