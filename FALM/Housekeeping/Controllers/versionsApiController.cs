...
namespace FALM.Housekeeping.Controllers
{
    ...
    public class VersionsApiController : UmbracoApiController
    {
        ...
        /// <returns>List<CleanupResultModel></returns>
        [HttpPost]
        public List<CleanupResultModel> PostDeleteVersionsByCount(int versionsToKeep)
        {
            try
            {
                ...
                using (var db = DbHelper.ResolveDatabase())
                {
                    ...
                    cleanupResult.Type = "cmsPreviewXml";
                    cleanupResult.Result = iResultCount;
                    ...
                    cleanupResult = new CleanupResultModel();
                    cleanupResult.Type = "cmsContentVersion";
                    cleanupResult.Result = iResultCount;
                    cleanupSummary.Add(cleanupResult);
                    dbComm.Dispose();
                    ...
                    iResultCount = dbComm.ExecuteNonQuery();
                    cleanupResult = new CleanupResultModel();
                    cleanupResult.Type = "cmsPropertyData";
                    cleanupResult.Result = iResultCount;
                    cleanupSummary.Add(cleanupResult);
                    dbComm.Dispose();
                    ...
                    iResultCount = dbComm.ExecuteNonQuery();
                    cleanupResult = new CleanupResultModel();
                    cleanupResult.Type = "cmsDocument";
                    cleanupResult.Result = iResultCount;
                    cleanupSummary.Add(cleanupResult);
                    dbComm.Dispose();
